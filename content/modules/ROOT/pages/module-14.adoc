...
[source,bash,role="execute",subs=attributes+]
----
podman build -t scratch:std -f Containerfile.std --cap-add=all --security-opt=label=type:container_runtime_t --device /dev/fuse
----
...
[source,bash,role="execute",subs=attributes+]
----
podman build -t scratch:mini -f Containerfile.mini --cap-add=all --security-opt=label=type:container_runtime_t --device /dev/fuse
----
