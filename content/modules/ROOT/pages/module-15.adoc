...
----
FROM registry-{guid}.{domain}/httpd
...
[source,bash,role="execute",subs=attributes+]
----
podman build --file Containerfile.wp --tag registry-{guid}.{domain}/caddy-wp
----
And of course push it to the local registry:

[source,bash,role="execute",subs=attributes+]
----
podman push registry-{guid}.{domain}/caddy-wp
----
...
[source,bash,role="execute",subs=attributes+]
----
sudo bootc switch registry-{guid}.{domain}/caddy-wp
----
...
....
  Staged image: node.prk8w.gcp.redhatworkshops.io/caddy-wp
       ...
       Version: 9.6 (2025-05-15 14:16:09.629889448 UTC)
...
[source,bash,role="execute",subs=attributes+]
----
podman build --file Containerfile.wp --tag registry-{guid}.{domain}/caddy-wp:V2
----
And of course push it to the local registry:

[source,bash,role="execute",subs=attributes+]
----
podman push registry-{guid}.{domain}/caddy-wp:V2
----
...
[source,bash,role="execute",subs=attributes+]
----
podman images registry-{guid}.{domain}/caddy-wp
----
...
[source,bash,role="execute",subs=attributes+]
----
podman image tag registry-{guid}.{domain}/caddy-wp:V2 registry-{guid}.{domain}/caddy-wp:latest
----
...
[source,bash,role="execute",subs=attributes+]
----
podman push registry-{guid}.{domain}/caddy-wp:latest
----
