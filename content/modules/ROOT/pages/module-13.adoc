...
The reference is made up of[https://oras.land/docs/concepts/reference/,window=_blank] the registry, the repository with an optional namespace, and the tag. 
...
podman images base
----
There's several ways to address this, we'll discuss two in this lab.
...
This may seem like a hassle, which is where processes like GitOps enter the picture.
...
The full scope of a GitOps environment is out of the scope of this lab, however you can get more details from our introductory blog post[https://www.redhat.com/en/blog/jumpstart-gitops-image-mode,window=_blank].
